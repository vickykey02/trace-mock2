...
export const ALL_ACTIONS = [
  {
    ...
    short: 'Bring deine eigenen Gefäße und Beutel für den Kauf von Lebensmitteln mit in den Laden.',
    ...
    difficulty: 'Leicht',
    points: 10,
    pointsDescription: '10 Punkte pro Einkauf. Maximal 20 Punkte pro Woche.',
  ...
  },
  {
    ...
    short: 'Nimm an einer professionell organisierten Baumpflanzaktion in Chemnitz oder Umgebung teil.',
    description: 'Suche eine Baumpflanzaktion in deiner Nähe und melde dich an. Dort erhältst du die notwendigen Materialien und Anleitungen, um einen Baum zu pflanzen und zu pflegen. Nach der Pflanzung kannst du einen QR Code scannen, um die Handlung einzutragen.',
    category: 'Natur',
    label: 'Community',
    ...
    difficulty: 'Mittel',
    points: 25,
    pointsDescription: '25 Punkte pro Baum',
  ...
  },
  {
    ...
    short: 'Nimm den Bus oder die Bahn statt das Auto für kurze Strecken.',
    description: 'Nutze öffentliche Verkehrsmittel für deine täglichen Wege. Beim Aus- und Einsteigen kannst du einen QR Code scannen, um die Handlung einzutragen.',
    category: 'Mobilität',
    label: 'Individual',
    ...
    difficulty: 'Leicht',
    points: 5,
    pointsDescription: '5 Punkte pro Tag, maximal 20 Punkte pro Woche',
  ...
  },
  {
    id: 4,
    title: 'Carsharing',
    short: 'Teile ein Auto mit anderen, anstatt ein eigenes zu besitzen.',
    description: 'Melde dich bei einem Carsharing-Dienst an und nutze gemeinsam genutzte Fahrzeuge für deine Fahrten. Beim Buchen kannst du einen QR Code scannen, um die Handlung einzutragen.',
    category: 'Mobilität',
    label: 'Individual',
    keywords: ['carsharing', 'mobilität', 'transport', 'co2'],
    information: 'Carsharing ermöglicht es mehreren Personen, ein Auto zu nutzen, ohne dass jeder ein eigenes besitzen muss. Dies reduziert die Anzahl der Fahrzeuge auf der Straße und damit auch den CO2-Ausstoß.',
    impact: 'Spart bis zu 1 Tonne CO2 pro Jahr',
    difficulty: 'Mittel',
    points: 30,
    pointsDescription: '30 Punkte pro Carsharing-Fahrt, maximal 60 Punkte pro Monat',
    tips: ['Plane deine Fahrten', 'Teile Fahrten mit Freunden', 'Nutze Carsharing für spontane Ausflüge'],
    showMap: false
  },
  {
    id: 5,
    title: 'Nachhaltige Mode',
    short: 'Kaufe Second-Hand Kleidung oder nachhaltige Labels.',
    description: 'Suche nach Second-Hand Läden oder nachhaltigen Modemarken in deiner Nähe oder online. Achte beim Kauf auf umweltfreundliche Materialien und faire Produktionsbedingungen. Beim Kauf kannst du einen QR Code scannen, um die Handlung einzutragen.',
    category: 'Shopping',
    label: 'Individual',
    ...
    difficulty: 'Leicht',
    points: 15,
    pointsDescription: '15 Punkte pro Kauf',
  ...
  },
  {
    ...
    short: 'Nutze dein Fahrrad statt das Auto für kurze Strecken.',
    descritpion: 'Fahre mit dem Fahrrad zu deinen Zielen, anstatt das Auto zu nehmen. Erlaube das Tracken deines Standorts, um die zurückgelegte Strecke zu erfassen und die Handlung einzutragen.',
    category: 'Mobilität',
    label: 'Individual',
    ...
    difficulty: 'Leicht',
    points: 10,
    pointsDescription: '10 Punkte pro Fahrt',
  ...
  },
  {
    id: 7,
    title: 'LED-Lampen',
    short: 'Wechsle zu LED-Lampen und spare bis zu 75% Energie.',
    description: 'Ersetze herkömmliche Glühlampen durch LED-Lampen, um Energie zu sparen und die Umwelt zu schonen. Nach dem Kauf kannst du die Handlung manuell eintragen.',
    category: 'Energie',
    label: 'Individual',
    ...
    points: 8,
    pointsDescription: '8 Punkte pro Lampe',
  ...
  },
  {
    ...
    short: 'Kaufe Produkte von lokalen Bauern und Herstellern.',
    description: 'Kaufe Produkte von lokalen Bauern und Herstellern, um Transportwege zu verkürzen und die lokale Wirtschaft zu unterstützen. Beim Kauf kannst du einen QR Code scannen, um die Handlung einzutragen.',
    category: 'Ernährung',
    label: 'Individual',
