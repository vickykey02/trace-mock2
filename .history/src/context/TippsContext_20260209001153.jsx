...
export const ALL_TIPPS = [
  ...
  {
	id: 4,
	title: 'Nachhaltige Mode erkennen',
	category: 'Shopping',
	shortDescription: 'Tipps, um nachhaltige Mode und Labels zu erkennen und bewusster einzukaufen.',
	keywords: ['mode', 'nachhaltig', 'shopping', 'labels'],
	description: 'Hier sind einige Tipps, um nachhaltige Mode zu erkennen:\n\n - **Achte auf Materialien**: Bevorzuge Kleidung aus natürlichen, biologischen oder recycelten Materialien wie Bio-Baumwolle, Leinen, Hanf oder recyceltem Polyester.\n - **Informiere dich über die Marke**: Recherchiere die Marken, von denen du kaufen möchtest, und prüfe ihre Nachhaltigkeitspraktiken, z.B. ob sie faire Arbeitsbedingungen bieten und umweltfreundliche Produktionsmethoden verwenden.\n - **Zertifizierungen beachten**: Achte auf Zertifizierungen wie GOTS (Global Organic Textile Standard), Fair Trade oder Bluesign, die nachhaltige Praktiken in der Textilindustrie kennzeichnen.',
	images: '/tipp-4.jpg',
	author: 'Edith Green',
  },
  {
	id: 5,
	title: 'Ressourcenschonend Waschen',
	category: 'Haushalt',
	shortDescription: 'Tipps, um Wasser und Energie beim Waschen zu sparen.',
	keywords: ['waschen', 'ressourcen', 'energie', 'wasser'],
	description: 'Hier sind einige Tipps, um beim Waschen Ressourcen zu schonen:\n\n - **Verwende die richtige Waschtemperatur**: Wasche bei niedrigen Temperaturen, um Energie zu sparen.\n - **Nutze volle Waschladungen**: Warte, bis die Waschmaschine voll ist, bevor du sie startest, um Wasser und Strom effizient zu nutzen.\n - **Wähle umweltfreundliche Waschmittel**: Verwende biologisch abbaubare Waschmittel, die weniger schädlich für die Umwelt sind.',
	images: '/tipp-5.webp',
	author: 'Olivia Kempe',
  }
];
