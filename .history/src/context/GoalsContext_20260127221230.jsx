//GoalsContext mit State-Management und Auto-Update
...
export const PRESET_GOALS = [
  ...
  {
    id: 'preset-2',
    title: '5x Unverpackt einkaufen',
    description: 'Kaufe 5 Mal in einem Unverpackt-Laden ein',
    category: 'Shopping',
    target: 5,
    unit: 'Einkäufe',
...
export const GoalsProvider = ({ children }) => {
  ...
  // Prüfen ob Ziel bereits aktiv ist
