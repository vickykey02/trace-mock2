...
export const ALL_TIPPS = [
  {
	...
	description: 'Anleitung um möglichst viel Plastik im Badezimmer zu reduzieren und nachhaltige Alternativen zu nutzen. Hier sind einige Schritte, die du befolgen kannst:\n\n1. <b>Zahnbürste</b>: Wechsle zu einer Zahnbürste aus Bambus oder einem anderen nachhaltigen Material.\n2. **Zahnpasta**: Verwende Zahnpasta in einer Glasverpackung oder probiere Zahnpasta-Tabletten aus.\n3. **Shampoo und Conditioner**: Entscheide dich für feste Shampoo- und Conditioner-Bars ohne Plastikverpackung.\n4. **Duschgel**: Nutze Duschgel in fester Form oder in einer Glasflasche.\n5. **Rasierer**: Verwende einen Rasierer mit austauschbaren Klingen anstelle von Einwegrasierern.\n6. **Deodorant**: Wechsle zu einem Deodorant in einer Glasverpackung oder einem festen Deodorant-Stick.\n7. **Wattepads**: Ersetze Einweg-Wattepads durch wiederverwendbare Baumwollpads.\n8. **Mülltrennung**: Achte darauf, dass du deinen Müll richtig trennst, damit recycelbare Materialien auch tatsächlich recycelt werden.',
	images: '/tipp-1.jpg'
},
  {
	id: 2,
