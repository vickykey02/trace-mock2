...
export const ALL_REWARDS = [
  {
    ...
    pointsCost: 100,
	anleitung: 'So löst du den Gutschein ein: Gehe auf Vinted, wähle deinen Lieblingsartikel aus und gib beim Bezahlen den Gutscheincode ein, den du nach dem Einlösen hier per Mail erhältst. Viel Spaß beim nachhaltigen Shoppen!',
  },
  {
    id: 2,
