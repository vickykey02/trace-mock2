...
//untersuchen warum Checkbox wenn man nochmal drauf geht leer ist obwohl Rangliste deaktiviert ist

import { useState } from 'react';

const Personalization = () => {
  const [rankingDisabled, setRankingDisabled] = useState(false);
  const [algorithmDisabled, setAlgorithmDisabled] = useState(false);
