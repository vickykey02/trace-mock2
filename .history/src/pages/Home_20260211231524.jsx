    ...
    <div style={{ padding: '30px', paddingBottom: '0'}}>
      ...
      */}
      ...
      <div style={{ marginTop: '20px' }}>
        ...
        {/* Add Action Button */}
        <button onClick={() => setIsScanOpen(true)} style = {{ 'none': 'none', width: 'calc(20% - 5px)', display: 'block', background: 'none', border: 'none', cursor: 'pointer', padding: 0, justifyContent: 'right', alignItems: 'center', display: 'flex' }}>
