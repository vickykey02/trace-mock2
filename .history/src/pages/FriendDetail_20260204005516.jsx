...
import FRIEND_GOALS from '../context/FriendsContext';
...
const FriendDetail = () => {
  ...
  const goal1 = FRIEND_GOALS.find(g => g.id === friend-3);
  const goal2 = FRIEND_GOALS.find(g => g.id === friend-2);
    ...
    <div style={{ padding: '20px', maxWidth: '600px', margin: '0 auto', paddingBottom: '100px' }}>
      ...
      <div style={{ marginTop: '30px', marginLeft: '20px', marginRight: '20px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '15px' }}>
          <h3 style={{ color: '#128b09', margin: 0 }}>🎯 Ziele</h3>
          <button
            onClick={() => {
              // TODO: Ziel hinzufügen
            }}
            style={{
              backgroundColor: '#128b09',
              color: '#fff',
      ...
      <div style={{ marginTop: '25px', marginLeft: '20px', marginRight: '20px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '15px' }}>
          <h3 style={{ color: '#ffc107', margin: 0 }}>💡 Eingereichte Tipps</h3>
          <button
            onClick={() => {
              // TODO: Tipp hinzufügen
            }}
            style={{
