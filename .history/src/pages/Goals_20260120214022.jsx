      ...
      <div style={{
        ...
        <div style={{
          ...
          {activeGoals.length > 0 ? (
            ...
            <p style={{ color: '#999', textAlign: 'center' }}>Keine aktiven Ziele. Starte ein neues Ziel!</p>
          )}
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {completedGoals.length > 0 ? (
            ...
            <p style={{ color: '#999', textAlign: 'center' }}>Noch keine Ziele erreicht. Du schaffst das!</p>
          )}
        </div>
      </div>
    </div>
