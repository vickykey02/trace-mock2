...
const NewGoal = () => {
    ...
    return (
      <div style={{ padding: '40px 20px', textAlign: 'center', paddingBottom: '100px' }}>
        <div style={{
          ...
          <p style={{ padding: '30px', fontSize: '20px', fontWeight: 'bold', color: '#128b09', margin: '0 0 10px 0' }}>
            Ziel hinzugefügt!
          </p>
  ...
  return (
    <div style={{ padding: '30px 20px', paddingBottom: '100px', maxWidth: 600, margin: '0 auto' }}>
      <h1 style={{ marginTop: '30px', margin: '0 0 20px 0', color: '#128b09' }}>Ziel hinzufügen</h1>
