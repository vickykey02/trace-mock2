    ...
    <div style={{ padding: '30px', paddingBottom: '0'}}>
      ...
      */}
      ...
      <div style={{ marginTop: '20px' }}>
        ...
        {/* Add Action Button */}
        <button onClick={() => setIsScanOpen(true)} style={{ width: 'calc(20% - 5px)', display: 'flex', background: 'none', border: 'none', cursor: 'pointer', padding: 0, justifyContent: 'flex-end', alignItems: 'center' }}>
