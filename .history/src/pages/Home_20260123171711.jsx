  ...
  return (
    <div style={{ padding: '20px', maxWidth: '600px', margin: '0 auto', paddingBottom: '100px' }}>
      ...
      <div style={{ display: 'flex', gap: '10px', marginTop: '15px', width: '100%' }}>
        ...
        <Link to="/Explore" style={{ textDecoration: 'none', flex: '2 1 0', minWidth: 0, display: 'block' }}>
          <div style={{
        ...
        {/* Faves Button */}
        <Link to="/favorites" style={{ textDecoration: 'none', flex: '1 1 0', minWidth: 0, display: 'block' }}>
          <div style={{
            backgroundColor: '#f8f9fa',
            borderRadius: '10px',
            padding: '12px 15px',
