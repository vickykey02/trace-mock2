//evtl. nochmals überarbeiten und verschönern (Emojis nicht so toll)
...
const ALL_BADGES = [
  {
    id: 1,
    name: 'Erster Tipp',
    icon: '/ersterTipp.png',  // Bild-Pfad (muss in /public liegen)
    isImage: true,  // Flag um zu wissen dass es ein Bild ist
    ...
    return (
      ...
      >
        <div style={{ fontSize: 40, marginBottom: 10 }}>
          {currentLevelObj ? currentLevelObj.icon : '📚'}
        </div>
