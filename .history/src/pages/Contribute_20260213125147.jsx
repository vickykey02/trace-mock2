...
const Contribute = () => {
  ...
  const actionNames = [ 'vegane Produkte kaufen', 'Öffis nutzen', 'erneuerbare Energien verwenden', 'LED-Lampen', 'Zug statt Flugzeug', 'nachhaltige Technik', 'Vermeidung von Lebensmittelverschwendung', 'Nutzung von Mehrwegprodukten', 'Elektroauto fahren', 'Kauf von Nachfüllprodukten', 'Kauf von Bio-Produkten'];
