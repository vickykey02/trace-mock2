...
const Home = () => {
  ...
  return (
    <div style={{ padding: '30px', paddingBottom: '0'}}>
      ...
      {/* 3er Set Buttons */}
      <div style={{ display: 'flex', gap: '5px', marginBottom: '20px', overflow: 'hidden', boxSizing: 'border-box', justifyContent: 'center', alignItems: 'flex-start' }}>
        <button 
      ...
      <Link to="/knowledge-base2" style={{ textDecoration: 'none'}}> 
        <div style={{
          ...
          <span style={{ fontSize: '28px', fontWeight: 'bolder', marginLeft: '10px' }}>➜</span>
          {/*<span><img src = "/pfeilwinkel-nach-rechts.png" alt="arrow" style = {{ width: '28px', height: '28px' }} /></span> */}
        </div>
      </Link>
      ...
      */}
      ...
      <div style={{ marginTop: '20px' }}>
        ...
        {/* Add Action Button */}
        <button onClick={() => setIsScanOpen(true)} style={{ background: 'none', marginTop: '-30px', border: 'none', cursor: 'pointer', padding: 0, display: 'flex', alignItems: 'center', justifyContent: 'flex-end', marginRight: '15px' }}>
