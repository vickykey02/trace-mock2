...
const ActionDetail = () => {
  ...
  const actionsData = {
    1: {
      id: 1,
      title: 'Plastik-freier Einkauf',
      description: 'Gehe mit Stoffbeuteln einkaufen und vermeide Einwegplastik',
      category: 'Shopping',
      ...
      tips: ['Nimm mehrere Beutel mit', 'Verwende Beutel mehrfach', 'Lagere sie griffbereit in deinem Auto']
    },
    2: {
      id: 2,
