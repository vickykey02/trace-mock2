...
const Home = () => {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '600px', margin: '0 auto', paddingBottom: '100px' }}>
      ...
      {/* Fakt des Tages */}
      <Link to={`/knowledge/${faktDesTages.id}`} style={{ textDecoration: 'none' }}>
        <div style={{
      ...
      <div style={{ display: 'flex', gap: '10px', marginTop: '15px' }}>
        ...
        <Link to="/Explore" style={{ textDecoration: 'none', flex: 2 }}>
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: '12px', color: '#666' }}>{allActions.length} Handlungen</div>
              </div>
            </div>
        ...
        {/* Faves Button */}
        <Link to="/favorites" style={{ textDecoration: 'none', flex: 0.5 }}>
          <div style={{
            backgroundColor: '#f8f9fa',
            borderRadius: '10px',
            padding: '12px 15px',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              <div>
                <div style={{ fontWeight: 'bold', fontSize: '14px', color: '#333' }}>Favoriten</div>
                <div style={{ fontSize: '12px', color: '#666' }}>Deine Liste</div>
              </div>
            </div>
            <span style={{ color: '#128b09', fontSize: '18px' }}>→</span>
          </div>
