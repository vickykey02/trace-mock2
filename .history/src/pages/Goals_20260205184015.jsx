...
export default function Goals() {
  ...
  const { getActiveGoals, getCompletedGoals, incrementProgress, getGoalById, setProgress } = useGoals();

  const activeGoals = getActiveGoals();
  
  // Einmalig beim Mount das Ziel auf 100% setzen
  useEffect(() => {
    setProgress('preset-4', 100);
  }, []);
