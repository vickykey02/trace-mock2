...
const NewGoal = () => {
  ...
  const handleOwnGoalSubmit = (e) => {
    ...
    if (!ownGoal.title || !ownGoal.target || !ownGoal.unit || !ownGoal.category || !ownGoal.label) {
  ...
  return (
    <div style={{ padding: '30px 20px', paddingBottom: '100px', maxWidth: 600, margin: '0 auto' }}>
      <h2 style={{ marginTop: '50px', margin: '50px 0 20px 0', color: '#128b09' }}>Ziel hinzufügen</h2>
