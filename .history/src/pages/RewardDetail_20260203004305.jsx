  ...
  return (
    <div style={{ padding: '20px', maxWidth: '600px', margin: '0 auto', paddingBottom: '100px' }}>
      ...
      <div style={{
        ...
        <p><strong>Schwierigkeit:</strong> {reward.difficulty}</p>
        <p><strong>Punkte:</strong> {reward.points}</p>
        <p><strong>Hintergrund:</strong> {reward.information}</p>
        <p><strong>Umweltauswirkung:</strong> {reward.impact}</p>
      </div>
      ...
      {reward.showMap && (
        <div style={{ marginBottom: '20px' }}>
          <LocationMap actionCategory={reward.category} />
        </div>
      )}
    </div>
  );
