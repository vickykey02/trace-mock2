...
const ActionDetail = () => {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '600px', margin: '0 auto', paddingBottom: '100px' }}>
      <div style={{ justifyContent: 'space-between', alignItems: 'center', marginBottom: '0px' }}>
        <h2 style={{ margin: 0, marginTop: '-50px', marginLeft: '50px' }}>{action.title}</h2>
        <div style={{ marginTop: '50px' }} >
          <AddButton2 actionId={action.id}/>
        </div>
      </div>
