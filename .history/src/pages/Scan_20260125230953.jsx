//noch QR Code anlegen der Daten enthält die dann in den Verlauf eingetragen werden
//Popup nach Scan mit Erfolgsmeldung und Punkten
//Button um erneut zu scannen
//Button um zum Home/Verlauf zurückzukehren
//Fehlerbehandlung wenn Kamera nicht funktioniert oder kein Zugriff erlaubt wurde
...
const Scan = () => {
  ...
  const { addApprovedAction } = useSubmittedActions();
  ...
  const handleQRDetected = (result) => {
    ...
    setIsApproved(true);
    addApprovedAction(randomCode.id);
  };
