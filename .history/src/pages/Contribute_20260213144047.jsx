...
const Contribute = () => {
  ...
  const categories = ['Allgemeine Nachhaltigkeit', 'Shopping', 'Mobilität', 'Energie', 'Haushalt', 'Abfall', 'Natur', 'Ernährung', 'Freizeit', 'Bildung', 'Soziales', 'Sonstiges'];
  //const actionNames = actions.map(action => action.title);
  const actionNames = [ 'vegane Produkte kaufen', 'Öffis nutzen', 'erneuerbare Energien verwenden', 'LED-Lampen kaufen', 'Zug statt Flugzeug', 'nachhaltige Technik', 'Vermeidung von Lebensmittelverschwendung', 'Nutzung von Mehrwegprodukten', 'Elektroauto fahren', 'Kauf von Nachfüllprodukten', 'Kauf von Bio-Produkten'];
  ...
  const handleSubmit = (e) => {
    ...
    // Validierung
    if (!formData.category || !formData.description.trim() || !formData.date || !formData.location.trim()) {
      alert('Bitte füllen Sie alle Pflichtfelder aus');
      return;
    }

    // Finde die ausgewählte Handlung und extrahiere die Punkte
