  ...
  return (
    <div style={{ padding: '20px', maxWidth: '600px', margin: '0 auto', paddingBottom: '100px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
        <h2 style={{ margin: 0, marginTop: '-15px', marginLeft: '50px',padding: '10px' }}>{knowledgeBite.title}</h2>
        <LikeButton knowledgeId={knowledgeBite.id} />
      </div>

      {/* Bild */}
      <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '20px' }}>
        <img src ={knowledgeBite.images} alt={knowledgeBite.title} style={{ width: '100%', height: '100%', borderRadius: '8px', objectFit: 'cover' }} />
      </div>
