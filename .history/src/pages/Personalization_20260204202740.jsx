...
const Personalization = () => {
  ...
  return (
    ...
    <div
      style={{ padding: '30px' }}>
      <h1>Personalisierung und Datenschutz</h1>
      </div>
      <div
      style = {{
      ...
      style = {{
        ...
        padding: '20px',}}>
        <label style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer' }}>
          <h3 style={{ margin: 0, color: 'white' }}>Personalisierte<br />Empfehlungen erhalten</h3>
		  <input 
            type="checkbox" 
      ...
      style = {{
        ...
        padding: '20px',}}>
        <label style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer' }}>
          <h3 style={{ margin: 0, color: 'white' }}>Standortnutzung<br />erlauben</h3>
		  <input 
            type="checkbox" 
