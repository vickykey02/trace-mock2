...
//eigenen Hintergrund mit Canva zeichnen evtl. --> Skyline und da vielleicht schon
//alle verfügbaren Sehenswürdigkeiten in schwarz drin --> rücken jeweils nach vorn und werden
//ausgemalt, erscheinen grün im Hintergrund wenn fertig --> Ziel: Chemnitz als grüne Stadt
...
const Home = () => {
  ...
  return (
    <div style={{ padding: '20px', margin: '0 auto', paddingBottom: '100px', boxSizing: 'border-box', maxWidth: '100%', overflowX: 'hidden' }}>
      ...
      {/* 4 Buttons nebeneinander */}
      <div style={{ display: 'flex', gap: '5px', marginBottom: '20px', overflow: 'visible', boxSizing: 'border-box' }}>
        <button style={{ flex: 1, minWidth: 0, boxSizing: 'border-box' }}> 1</button>
        <button style={{ flex: 1, minWidth: 0, boxSizing: 'border-box' }}> 2</button>
        <button style={{ flex: 1, minWidth: 0, boxSizing: 'border-box' }}> 3</button>
        <button style={{ flex: 1, minWidth: 0, boxSizing: 'border-box' }}> 4</button>
      </div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', minWidth: 0, overflow: 'hidden' }}>
              ...
              <div style={{ minWidth: 0, overflow: 'hidden' }}>
                <div style={{ fontWeight: 'bold', fontSize: '14px', color: '#333' }}>Entdecken/Inspiration</div>
