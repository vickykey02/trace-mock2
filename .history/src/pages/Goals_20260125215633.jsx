//to do: automatische Aktualisierung bei Handlungsabschluss einbinden (bei Label given)
  ...
  return (
    <div style={{
      ...
      <div style={{
		...
		<Link to="/new-goal" style={{ textDecoration: 'none' }}>
          <div style={{
            ...
            <span style={{ fontSize: '24px' }}>Ziel hinzufügen</span>
          </div>
        </Link>
