    ...
    <div style={{ padding: '30px', paddingBottom: '0'}}>
      ...
      */}
      ...
      <div style={{ marginTop: '20px' }}>
        ...
        {/* Add Action Button */}
        <button onClick={() => setIsScanOpen(true)} style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0, display: 'flex', alignItems: 'center', justifyContent: 'flex-end', marginRight: '10px' }}>
