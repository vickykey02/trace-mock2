    ...
    <div style={{ padding: '30px', paddingBottom: '100px' }}>
      ...
      <div style={{ display: 'flex', gap: '10px', marginBottom: '20px' }}>
        ...
        <Link to="/remember" style={{ flex: 1, textDecoration: 'none' }}>
          ...
          >
            {<img src="/documentation.png" alt="Gemerkte Tipps" style={{ width: '34px', height: '34px' }} />}
            gemerkte Tipps
          </button>
        </Link>
        ...
        <Link to="/submit" style={{ flex: 1, textDecoration: 'none' }}>
          ...
          >
            <img src="/contract.png" alt="Tipp einreichen" style={{ width: '34px', height: '34px' }} />
            Tipp einreichen
          </button>
        </Link>
      </div>
