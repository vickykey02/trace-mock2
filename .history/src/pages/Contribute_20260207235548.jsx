...
const Contribute = () => {
  ...
  const actionNames = [ 'vegane Produkte kaufen', 'Öffis nutzen', 'erneuerbare Energien verwenden', 'LED-Lampen', 'Zug statt Flugzeug', 'nachhaltige Technik', 'Vermeidung von Lebensmittelverschwendung'];
