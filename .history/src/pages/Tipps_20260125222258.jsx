  ...
  return (
    <div style={{ padding: '30px', paddingBottom: '100px' }}>
      ...
      <div style={{ display: 'flex', flex: '1', marginBottom: '20px' }}>
        <Link to="/remember" style={{ display: 'flex', flex: '1',marginBottom: '20px', textDecoration: 'none' }}>
          <button
            style={{
      ...
      <div style={{ display: 'flex', flex: '1',marginBottom: '20px' }}>
        <Link to="/submit" style={{ display: 'flex', flex: '1',marginBottom: '20px',textDecoration: 'none' }}>
          <button
            style={{
              backgroundColor: '#128b09ff',
              color: '#fff',
