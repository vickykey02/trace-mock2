  ...
  return (
    <div style={{ padding: '20px', margin: '0 auto', paddingBottom: '100px' }}>
      ...
      <div style={{ display: 'flex', gap: '5px', marginBottom: '20px', width: '100%' }}>
        <button style={{ flex: 1, minWidth: 0 }}> 1</button>
        <button style={{ flex: 1, minWidth: 0 }}> 2</button>
        <button style={{ flex: 1, minWidth: 0 }}> 3</button>
        <button style={{ flex: 1, minWidth: 0 }}> 4</button>
      </div>
