...
const Impact = () => {
  return (
    <div style = {{ 
      ...
      backgroundSize: 'cover',           // Bild füllt den Container
      backgroundPosition: 'center',      // Bild wird zentriert
      backgroundRepeat: 'no-repeat',     // Keine Wiederholung
      minHeight: '100vh',                // Mindesthöhe für mehr Sichtbarkeit
    }}>
    <div style = {{ marginTop: '-30px', padding: '30px' }}>
      <h1>Impact</h1>

      <div style={{ marginTop: '20px', padding: '10px', border: '1px solid #ccc', borderRadius: '8px', backgroundColor: '#f9f9f9', opacity: '0.7' }}>
        <h2 style = {{ opacity: '0.9' }}>Dein aktueller Impact:</h2>
        <ul>
