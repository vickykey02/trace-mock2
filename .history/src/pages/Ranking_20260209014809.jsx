...
const Ranking = () => {
  ...
  if (rankingDisabled) {
    return (
      <div style={{ padding: '20px', textAlign: 'center' }}>
        ...
        <p style={{marginTop: '-40px'}}>Die Rangliste ist deaktiviert. Du kannst sie in den Einstellungen wieder aktivieren.</p>
      </div>
    );
  }
  ...
  return (
    <div style={{ padding: '20px', paddingBottom: '100px' }}>
      <h2 style={{ textAlign: 'left', marginTop: '3px', marginLeft: '55px' }}>Rangliste</h2>
      <button 
          onClick={() => navigate('/personalization')}
          style={{ 
            position: 'absolute',
