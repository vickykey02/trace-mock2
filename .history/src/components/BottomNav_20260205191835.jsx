    ...
    <>
      <nav style={{
		...
		<button onClick={() => setIsKnowledgeOpen(true)} style={{
          ...getActiveStyle(['/knowledge', '/tipps']),
          border: 'none',
          cursor: 'pointer',
        }}>
          <img src="/idea.png" alt="Knowledge Base" style={{ width: '24px', height: '24px' }} />
