...
const Esse = ({ width = 60, height = 200 }) => {
  ...
  // Die 6 Farbsegmente der Esse (von unten nach oben)
  const segments = [
    { color: '#E8B4B8', height: 16 },  // Rosa
    { color: '#90C695', height: 16 },  // Grün
    { color: '#7DD3E8', height: 16 },  // Cyan/Hellblau
    { color: '#B794D6', height: 16 },  // Lila
    { color: '#F7D358', height: 28 },  // Gelb (Hauptteil)
    { color: '#F7D358', height: 8 }    // Gelb (Kopf/Spitze)
  ];
